      ...
      <div className="w-full max-w-md">
        ...
        <Card className="glass border-border/50">
          ...
          <CardFooter className="flex flex-col gap-4">
            <Link to="/auth/forgot-password" className="text-sm text-muted-foreground hover:text-primary transition-colors">{t('auth.forgotPassword')}</Link>
            <div className="text-sm text-muted-foreground">{t('auth.noAccount')} <Link to="/auth/register" className="text-primary hover:underline">{t('auth.register')}</Link></div>
          </CardFooter>
        </Card>
